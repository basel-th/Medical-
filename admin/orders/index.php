...
">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <form class="d-flex"  action="../orders/index.php" method="Get">
        <input class="form-control me-2" type="search" name="search" placeholder="Write Order Name" aria-label="Search">
...
?>
         ...
         <?php   $data= Sreach('orders','order_name',$search); $x=1;?>
